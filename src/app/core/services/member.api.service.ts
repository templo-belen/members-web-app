...
import { MemberDewInfoResponseModel, MemberErrorResponseModel, MemberListResponseModel } from '../models/api-response.model';
...
export class MemberApiService {
  ...
  public dewInfoById(memberId: number): Observable<MemberDewInfo | MemberErrorResponseModel> {
